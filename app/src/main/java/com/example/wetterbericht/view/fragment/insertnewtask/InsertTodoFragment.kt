package com.example.wetterbericht.view.fragment.insertnewtask
...
import com.example.wetterbericht.view.fragment.insertnewtask.adapter.ChipAdapter
import com.example.wetterbericht.view.fragment.insertnewtask.dialog.InsertAlarmChipFragment
import com.example.wetterbericht.view.fragment.insertnewtask.dialog.InsertTagFragment
...
class InsertTodoFragment : Fragment(){
    ...
    private val wordSource = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"

    private var userId = Random().ints(10, 0, wordSource.length)
        .asSequence()
        .map(wordSource::get)
        .joinToString("")
