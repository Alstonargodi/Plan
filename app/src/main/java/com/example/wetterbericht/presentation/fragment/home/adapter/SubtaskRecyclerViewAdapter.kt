...
class SubtaskRecyclerViewAdapter: ListAdapter<TodoSubTask,SubtaskRecyclerViewAdapter.ViewHolder>(ItemComprator()){

    class ViewHolder(val binding: ItemcvTodoSubtaskBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemcvTodoSubtaskBinding.inflate(LayoutInflater.from(parent.context), parent, false)
